...
func init() {
	...
	discoveryCmd.PersistentFlags().StringVar(&serverArgs.Service.Etcd.EtcdEndpoints, "etcd.endpoints", "127.0.0.1:2379",
		"Etcd endpoints for discovery")
	discoveryCmd.PersistentFlags().DurationVar(&serverArgs.Service.Etcd.Config.DialTimeout, "etcd.dialtimeout", 5*time.Second,
		"Dial timeout for the Etcd server")
	discoveryCmd.PersistentFlags().StringVar(&serverArgs.Service.Etcd.EtcdPrefix, "etcd.prefix", "/pilot",
		"Etcd endpoints for discovery")
	discoveryCmd.PersistentFlags().StringVar(&serverArgs.Service.Etcd.SdPrefix, "etcd.sd_prefix", "/ns",
